...
export default function WeddingHero() {
  ...
  const RSVP_URL = "https://docs.google.com/forms/d/e/1FAIpQLSeL06X2_j1gqoGKIWtW4ErzxxtH2AQe90WBFeI1ptQH7mDcKw/viewform?usp=publish-editor";
  const DEADLINE = new Date("2026-06-04T23:59:59");
  const isDisabled = new Date() > DEADLINE;
  ...
  return (
    <div ref={containerRef} className="relative bg-[#FAFAFA]">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-16">
          ...
          >
            ...
            <div className="space-y-4">
              <p className="font-elegant text-xl md:text-2xl text-slate-500 italic">
                The families of
              </p>

              <h2 className="font-elegant text-3xl md:text-5xl text-slate-800 leading-tight">
                Alhaji & Mrs Ismail Alli
              </h2>
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        {/* Card 1 — Traditional Marriage Rites */}
        <motion.div
          whileHover={{ y: -8 }}
        ...
        >
          <div className="absolute top-0 right-0 w-24 h-24 bg-teal-50/50 rounded-bl-[100px] -mr-8 -mt-8 group-hover:bg-teal-50 transition-colors" />
          ...
          <div className="pt-4 flex items-center gap-3">
            ...
            <p className="text-xs font-bold text-slate-600 uppercase tracking-tighter">
              Color Code: Onion Pink &amp; Teal
            </p>
          </div>
        </motion.div>

        {/* Card 2 — The Church Blessing */}
        <motion.div
          whileHover={{ y: -8 }}
        ...
        >
          <div className="absolute top-0 right-0 w-24 h-24 bg-pink-50/50 rounded-bl-[100px] -mr-8 -mt-8 group-hover:bg-pink-50 transition-colors" />
      ...
      {/* Single RSVP Button + Warning — centered below both cards */}
      <div className="flex flex-col items-center gap-3">

        {isDisabled ? (
          <button
            disabled
            className="w-full max-w-sm text-center px-8 py-4 rounded-full text-sm font-black uppercase tracking-widest bg-slate-100 text-slate-400 cursor-not-allowed"
          >
            RSVP Closed
          </button>
        ) : (
          <a
            ...
            className="inline-block w-full max-w-sm text-center px-8 py-4 rounded-full text-sm font-black uppercase tracking-widest bg-gradient-to-r from-teal-600 to-pink-500 text-white hover:opacity-90 shadow-lg transition-all"
          >
            RSVP Here
          </a>
        )}
        ...
        <p className="text-xs text-slate-400 font-medium text-center">
          {isDisabled
            ? "RSVP closed on June 4, 2026."
            : "⚠️ RSVP closes on June 4, 2026 — don't miss it!"}
        </p>
